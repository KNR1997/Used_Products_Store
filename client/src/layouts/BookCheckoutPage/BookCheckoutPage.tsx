...
export const BookCheckoutPage = () => {
    ...
    }, [isReviewLeft, deleteReviewStatus]);
    ...
    async function deleteReview() {
        const url = `http://localhost:8080/api/reviews/secure/review/delete/?bookId=${bookId}`;
        const requestOptions = {
            method: 'DELETE',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
    ...
    return (
        <div>
            <div className='container d-none d-lg-block'>
                ...
                <hr />
                <LatestReviews reviews={reviews} bookId={book?.id} mobile={false} deleteReview={deleteReview} />
            </div>
            <div className='container d-lg-none mt-5'>
                ...
                <CheckoutAndReviewBox book={book} mobile={true} currentLoansCount={currentLoansCount} 
                    ...
                    checkoutBook={checkoutBook} isReviewLeft={isReviewLeft} submitReview={submitReview} />
                <hr />
                <LatestReviews reviews={reviews} bookId={book?.id} mobile={true} deleteReview={deleteReview} />
            </div>
        </div>
    );
}